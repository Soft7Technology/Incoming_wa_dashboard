...
//   const { companyId, messages } = job.data;

//   console.log(`Starting bulk message send for company ${companyId}, total messages: ${messages.length}`);
...
//           try {
//             const message = await MessageService.bulkSendMessages(companyId[
//             {
...
//     console.log(`Bulk message send completed for company ${companyId}. Total: ${results.total}, Successful: ${results.successful}, Failed: ${results.failed}`);

//     return results;
//   } catch (error: any) {
//     console.error(`Bulk message send failed for company ${companyId}:`, error);
//     throw error;
//   }
// }
